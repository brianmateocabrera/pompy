...
import { escaparHTML, crearTarjeta, activarTarjetas, activarGalerias } from './index-tarjetas.js';
...
function obtenerProductosFiltrados() {
    ...
    const disponibilidadSeleccionada = disponibilidad.value;
...
disponibilidad.addEventListener('change', renderizar);
ordenamiento.addEventListener('change', renderizar);
