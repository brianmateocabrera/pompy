...
export default function handler(req, res) {
  ...
  // Seguridad: limitar archivos modificables
  const rutasPermitidas = [
    'data/productos.json'
  ];

  const esImagenPermitida = path.startsWith('public/imagenes/');

  if (!rutasPermitidas.includes(path) && !esImagenPermitida) {
  ...
  // Los archivos JSON necesitan ser convertidos.
